...
CREATE TABLE `recipe` (
  ...
  KEY `fk_recipe_AccountId_idx` (`AccountId`),
  CONSTRAINT `fk_recipe_AccountId` FOREIGN KEY (`AccountId`) REFERENCES `account` (`AccountId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
