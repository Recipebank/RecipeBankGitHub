package com.example.rbshoppinglist;
...
public class ShoppingList extends Activity {
	...
	private class ShoppingListControl {
		...
		private final String URL = "http://" + "10.0.2.2"
				+ ":8088/RecipeBankWebServices/services/ShoppingList?wsdl";
		...
		public void excuteAll() {
			...
			shopListProp.setValue(accountId);// set value for userName variable
